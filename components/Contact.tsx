...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="min-h-screen relative overflow-hidden bg-[#0a0a14] flex items-center">
      ...
      <div className="max-w-5xl mx-auto px-6 py-20 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-6 py-2.5 bg-white/5 border border-white/10 rounded-full mb-8">
            ...
            <span className="text-[#00F5D4] font-mono text-xs tracking-[3px] uppercase">Loosing the Chains of addiction</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-12">
            If you are a school dropout, struggling with drugs, a young mother, or a person with disability — 
          ...
          <div className="max-w-2xl mx-auto mb-16">
            <p className="text-gray-400 text-lg leading-relaxed">
              We don't see you as a problem.<br />
              We see you as a <span className="text-[#FF0080] font-semibold">dormant processor</span> waiting to be activated.
            </p>
            <p className="text-gray-400 text-lg leading-relaxed mt-6">
              The Logic Lab in Mpondwe-Lhubiriha is not just a training center.<br />
              It's your gateway out of addiction, poverty, and limitation — into digital skills, remote income, and a new identity.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center gap-6">
            <Link href="/apply">
              <button className="group relative px-16 py-6 bg-gradient-to-r from-[#FF0080] to-[#00F5D4] hover:from-[#FF0080] hover:to-[#FF0080] 
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <div className="text-gray-400 text-sm">Participants Per Cohort</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <div className="text-gray-400 text-sm">New Life Opportunities</div>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-[#00F5D4] font-medium text-lg">
              From the border town of Mpondwe to the global digital economy —<br />
